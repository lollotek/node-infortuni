  ...
  try {
    ...
    if (response.status === 200) { //
      ...
      for (const ledJson of ledConfigsJson) { //
        ...
        // IMPORTANT: Adjust maxIntensity if your PWM range is different (e.g., 0-255)
        // If server sends 0-1023, you'll need to scale it.
        // Assuming server sends 0-255 for RPi for now, or you scale it:
